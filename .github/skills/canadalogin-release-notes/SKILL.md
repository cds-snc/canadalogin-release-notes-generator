...
7. Exclude release-only commits, generated changelog edits, deployment bookkeeping, lock-file-only changes, formatting, comments, routine dependency bumps, and dev tooling. Exclude all Manage App identity-verification work, including related tests, documentation, dependencies, and deployment-only changes.
